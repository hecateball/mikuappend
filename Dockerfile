...
ENV PAYARA_PACKAGE https://s3-eu-west-1.amazonaws.com/payara.fish/Payara+Downloads/Payara+4.1.2.174/payara-micro-4.1.2.174.jar
...
ENV LOG_DIR /var/log/mikuappend
...
RUN apk update \
 ...
 && chown -R mikuappend:mikuappend $LOG_DIR \
